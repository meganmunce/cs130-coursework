...
<p>Boston, MA</p>
  ...
  <p>Remote</p>
    <ul>
      <li>Taught at the Philadelphia session of the Victory Briefs Institute (VBI) summer debate camp for high school students</li>
      <li>Led a group of ~10 students in research and argumentation skills</li>
      <li>Held lectures specific debate topics and strategies</li>
    </ul>
</section>
...
const checkResume = () => {
    ...
    else if (resumeShown == "false" && topShown == "false" && multimediaShown == "true") {
      document.querySelector('.viewer').innerHTML = resumeHidden;
      document.querySelector('.viewer').innerHTML = resumeContent;
      resumeShown = "true";
      topShown = "false";
...
const checkTop = () => {
    if (resumeShown == "false" && topShown == "false" && multimediaShown == "false") {
      document.querySelector('.viewer').innerHTML = topArticles;
      resumeShown = "false";
      topShown = "true";
      multimediaShown = "false";
      return resumeShown;
...
const checkMultimedia = () => {
    if (multimediaShown == "false" && topShown == "false" && resumeShown == "false") {
