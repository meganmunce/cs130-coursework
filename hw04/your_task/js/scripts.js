...
const attachEventListener = () => {
  ...
  //use queryselectorall when there are multiple html elements with the same class name
}

const handleClick = (e) => {
  document.querySelector("footer .track-item").innerHTML = e.currentTarget.innerHTML;
  //current.target gives you the entire thing the event listener is attached to
